...
import { initialState, setFilters, type FiltersState } from "@/state";
import {
  Select,
  SelectContent,
  SelectItem,
...
const FiltersFull = () => {
  ...
  const handleSubmit = () => {
    ...
    debouncedUpdateURL(localFilters);
  };

  const handleReset = () => {
    setLocalFilters(initialState.filters);
    dispatch(setFilters(initialState.filters));
    debouncedUpdateURL(initialState.filters);
  };
      ...
      <div className="flex flex-col space-y-6">
        ...
        <div className="flex gap-4 mt-6">
          <Button
            ...
            className="flex-1 bg-primary-700 text-white font-bold rounded-xl"
          >
            Apply
          </Button>
          <Button
